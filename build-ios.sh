...
libtool -static \
  $BUILD_DIR/simulator/liblpr_sdk_static.a \
  third_party/onnxruntime/ios/onnxruntime.xcframework/ios-arm64-simulator/libonnxruntime.a \
  -o $BUILD_DIR/simulator/liblpr_combined.a
